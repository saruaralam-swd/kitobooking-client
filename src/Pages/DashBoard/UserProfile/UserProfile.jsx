      ...
      <div className="flex items-center justify-between">
        <div className="flex gap-2">
          ...
          <div>
            ...
            {isAdmin && (
              <h2 className="text-gray-700 text-sm">Account Type: Admin</h2>
            )}
            {isSeller && (
              <h2 className="text-gray-700 text-sm">Account Type: Seller</h2>
            )}
            {isBuyer && (
              <h2 className="text-gray-700 text-sm">Account Type: Buyer</h2>
            )}
          </div>
        </div>
        ...
        <label
          ...
          className="bg-primary hover:bg-blue-800 btn btn-sm flex justify-center"
        >
